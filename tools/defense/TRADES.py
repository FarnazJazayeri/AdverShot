...
def train(model, train_loader, val_loader, optimizer, criterion, device, epoch=100, weight_dir="weights/checkpoints", store_dir="weights/checkpoints", num_classes=22, pretrain=False, attack=None,
 data_attack="all", beta=1.0, eps_update=0, eps_delta=8/255, adv_threshold=0.5):
    ...
    for epoch in range(epoch):
        ...
        for batch_idx, (images, labels) in enumerate(train_loader):
            ...
            loss_natural = F.cross_entropy(output, labels)
