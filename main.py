...
def main(args):
    ...
    if args.weight is not None:
        ...
        train_loss_list = params['train_loss']
        train_acc_list = params['train_acc']
        train_loss_r_list = params['train_loss_r']
        train_acc_r_list = params['train_acc_r']
        val_loss_list = params['val_loss']
        val_acc_list = params['val_acc']
        val_loss_r_list = params['val_loss_r']
        val_acc_r_list = params['val_acc_r']
        init_step = params['epoch']
    else:
        init_step = 0
    ...
    if args.mode == "train":
        ...
        # val_loss_list, val_acc_list, train_loss_list, train_acc_list = [], [], [], []
        # val_loss_r_list, val_acc_r_list, train_loss_r_list, train_acc_r_list = [], [], [], []
        for step in range(init_step, init_step + args.epoch):
...
if __name__ == '__main__':
    ...
    argparser.add_argument('--meta_lr', type=float, help='meta-level outer learning rate', default=0.00001)  # 0.001
    ...
    argparser.add_argument('--hidden_channel', type=int, help='hidden_channel', default=128)  # 64 128 512
    argparser.add_argument('--emb_channel', type=int, help='emb_channel', default=64)  # 64
    argparser.add_argument('--num_layers', type=int, help='The number of layers', default=3)  # 3
    argparser.add_argument('--weight', type=str, help='The learning phase', default="/home/qle/Project/MetaLearning_FewShotLearning/MAML-Pytorch/experiments/cifar10/nonfs_classification/l3_h128/checkpoints/best_new.pt")
    argparser.add_argument('--store_dir', type=str, help='The learning phase', default="/home/qle/Project/MetaLearning_FewShotLearning/MAML-Pytorch/experiments/cifar10/nonfs_classification/l3_h128")
    ...
    ### Learning phases
    argparser.add_argument('--epoch', type=int, help='epoch number', default=100)  # 1000 5000
